...
mod tests {
    ...
    fn part_1(#[case] file: &str, #[case] expected: usize) {
        let result = run_for_file(2024, 5, "Part 1", file, get_sum_of_correct_middle_points);
    ...
    fn part_2(#[case] file: &str, #[case] expected: usize) {
        let result = run_for_file(2024, 5, "Part 2", file, get_sum_of_incorrect_middle_points);
        assert_aoc!(result, expected)
    }
}
